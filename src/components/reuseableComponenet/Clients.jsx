        ...
        <div className="flex flex-col lg:flex-row justify-between space-y-10 lg:space-y-0 lg:space-x-10">
          <div className="lg:w-1/2 flex flex-col gap-4">
            ...
            <div className="bg-[#22A8C6] py-5 sm:p-10 lg:p-12 flex w-full flex-col items-center lg:items-start text-white text-center rounded-lg">
              <h2 className="md:text-[38px] md:leading-[49px] text-white md:py-6 mb-4 w-full font-fixture  text-[28px] px-4 text-left leading-[40px] tracking-[-0.04em]">
                What our clients
                and partners say
              </h2>
              ...
              <div className="flex gap-4 flex-row text-center items-center  w-full justify-center md:space-y-6 lg:space-y-0 md:lg:space-x-10 md:mt-6">
                <div className="flex flex-col items-center lg:items-start text-center lg:text-left">
                  <p className="text-lg lg:text-xl md:leading-[32.5px] text-[20px] font-semibold leading-[32.5px] text-center">
                    Peoples
                  </p>
                  <p className="font-bold text-2xl lg:text-5xl md:py-3 md:leading-[55px] md:tracking-tight text-[30.03px] font-fixture leading-[55px] tracking-[-0.04em]">
                    850+
                  </p>
                  <p className="font-poppins text-sm lg:text-base md:leading-[32.5px] text-[20px] font-semibold leading-[32.5px] text-center">
          ...
          <div className="lg:w-1/2 flex flex-col items-start">
            {/* Testimonial Heading */}
            <div className="w-full">
              <h2 className="font-fixture md:text-[30.02px] mb-4 text-left text-black md:leading-[49px]   w-full max-w-3xl text-[30.02px] font-semibold leading-[55px] tracking-[-0.04em]">
                <span className="flex items-start justify-start md:leading-8 font-fixture text-[30.02px] font-semibold leading-[55px] tracking-[-0.04em]">
                  What our clients
                  <svg
                    width={45}
                    height={45}
              ...
              {/* Testimonial Text */}
              <p className="text-[15px] md:text-[17.16px] leading-6 md:leading-[35.54px] text-[#000102] mb-4 font-poppins">
                    ...
                    <div className="p-1">
                      <div className="bg-gray-100 py-10 md:py-16 px-10 flex flex-col items-center lg:items-start text-center lg:text-left rounded-lg border border-gray-300">
                        ...
                        <div className="text-center lg:text-left w-full flex items-center justify-center flex-col">
                          <h2 className="text-[24px] font-fixture md:text-[30px] font-semibold text-[#000102] mb-2">
                            Cameron Green
                          </h2>
                          <p className="text-[16px] font-poppins md:text-[18px] text-[#22A8C6] font-poppins">
                            Client
                          </p>
                        </div>
                      </div>
